...
final class TopRatedMovieViewModel: ObservableObject {
    ...
    private func fetch(page:Int) {
        APIService.shared.getTopRatedMovies(page: page) { popularMoviesObject, error in
    ...
    func saveDataToCoreDataForCache(movies:Movie) {
        CoreDataHelper.shared.saveMovies(movies: movies.results, isPopular: false)
    }
